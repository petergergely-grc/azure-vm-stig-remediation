<#
.SYNOPSIS
    Disables Windows Game Recording and Broadcasting (Xbox Game Bar/DVR).
.NOTES
...
if ($verify -eq 0) {
    Write-Host "[PASS] AllowGameDVR = $verify. STIG WN11-CC-000252 remediated." -ForegroundColor Green
} else {
