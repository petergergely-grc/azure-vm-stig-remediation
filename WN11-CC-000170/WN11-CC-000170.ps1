<#
.SYNOPSIS
    Configures Microsoft accounts to be optional for modern style apps.
.NOTES
...
if ($verify -eq 1) {
    Write-Host "[PASS] MSAOptional = $verify. STIG WN11-CC-000170 remediated." -ForegroundColor Green
} else {
