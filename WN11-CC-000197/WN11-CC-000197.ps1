<#
.SYNOPSIS
    Disables Microsoft consumer experiences (app suggestions, tips, etc.).
.NOTES
...
if ($verify -eq 1) {
    Write-Host "[PASS] DisableWindowsConsumerFeatures = $verify. STIG WN11-CC-000197 remediated." -ForegroundColor Green
} else {
